...
CREATE TABLE `atendimentos` (
  ...
  `status` enum('pendente','em_andamento','concluido','cancelado') DEFAULT 'concluido',
...
(1, 'Administrador', 'admin@atendelab.com', '$2y$10$J9P2kU2BAMZ3TZcuxTsW4e1D/lka8EocYHzvyoOZmCNcWDQz3RuVC', 'admin', 'ativo', '2026-06-03 17:33:56');
...
ALTER TABLE `atendimentos`
  ...
  ADD KEY `fk_atendimentos_tipos_atendimentos` (`id_tipo_atendimento`);
...
ALTER TABLE `atendimentos`
  ...
  ADD CONSTRAINT `fk_atendimentos_tipos_atendimentos` FOREIGN KEY (`id_tipo_atendimento`) REFERENCES `tipos_atendimentos` (`id`),
